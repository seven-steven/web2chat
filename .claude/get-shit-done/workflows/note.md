...
- **Global scope**: `/data/coding/projects/seven/agent-web-cliper/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/data/coding/projects/seven/agent-web-cliper/.claude/notes/`)
...
2. Glob `/data/coding/projects/seven/agent-web-cliper/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/data/coding/projects/seven/agent-web-cliper/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/data/coding/projects/seven/agent-web-cliper/.claude/notes/` — works in any directory
