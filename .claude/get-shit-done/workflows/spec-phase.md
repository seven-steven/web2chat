...
```bash
INIT=$(node "/data/coding/projects/seven/agent-web-cliper/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/data/coding/projects/seven/agent-web-cliper/.claude/get-shit-done/templates/spec.md.
