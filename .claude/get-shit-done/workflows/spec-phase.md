...
```bash
INIT=$(node "/Users/seven/data/coding/projects/seven/web2chat/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/seven/data/coding/projects/seven/web2chat/.claude/get-shit-done/templates/spec.md.
