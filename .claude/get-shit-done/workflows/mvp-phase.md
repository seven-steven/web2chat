...
<required_reading>
@/Users/seven/data/coding/projects/seven/web2chat/.claude/get-shit-done/references/user-story-template.md
@/Users/seven/data/coding/projects/seven/web2chat/.claude/get-shit-done/references/spidr-splitting.md
@/Users/seven/data/coding/projects/seven/web2chat/.claude/get-shit-done/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@/Users/seven/data/coding/projects/seven/web2chat/.claude/get-shit-done/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@/Users/seven/data/coding/projects/seven/web2chat/.claude/get-shit-done/references/user-story-template.md`:
...
Run the SPIDR rules from `@/Users/seven/data/coding/projects/seven/web2chat/.claude/get-shit-done/references/spidr-splitting.md`. Briefly:
