...
```
Task(
  prompt="Read /Users/seven/data/coding/projects/seven/web2chat/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/seven/data/coding/projects/seven/web2chat/.claude/get-shit-done/templates/VALIDATION.md`
