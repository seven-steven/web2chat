...
```
Task(
  prompt="Read /data/coding/projects/seven/agent-web-cliper/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/data/coding/projects/seven/agent-web-cliper/.claude/get-shit-done/templates/VALIDATION.md`
