...
INSTALL_JS_GLOBAL="/Users/seven/data/coding/projects/seven/web2chat/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/seven/data/coding/projects/seven/web2chat/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
