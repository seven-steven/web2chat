...
INSTALL_JS_GLOBAL="/data/coding/projects/seven/agent-web-cliper/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /data/coding/projects/seven/agent-web-cliper/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
