...
See /data/coding/projects/seven/agent-web-cliper/.claude/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using /data/coding/projects/seven/agent-web-cliper/.claude/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using /data/coding/projects/seven/agent-web-cliper/.claude/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from /data/coding/projects/seven/agent-web-cliper/.claude/get-shit-done/templates/discovery.md
...
Use /data/coding/projects/seven/agent-web-cliper/.claude/get-shit-done/templates/discovery.md.
