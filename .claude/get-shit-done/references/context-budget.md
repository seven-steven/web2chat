...
The keys live in `.claude/settings.json` (project) or `/Users/seven/data/coding/projects/seven/web2chat/.claude/settings.json` (global) — **not** in `.planning/config.json`:
