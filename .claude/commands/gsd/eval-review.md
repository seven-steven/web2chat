...
<execution_context>
@/data/coding/projects/seven/agent-web-cliper/.claude/get-shit-done/workflows/eval-review.md
...
<process>
Execute @/data/coding/projects/seven/agent-web-cliper/.claude/get-shit-done/workflows/eval-review.md end-to-end.
