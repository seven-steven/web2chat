...
<execution_context>
@/data/coding/projects/seven/agent-web-cliper/.claude/get-shit-done/workflows/analyze-dependencies.md
</execution_context>
...
<process>
Execute the analyze-dependencies workflow from @/data/coding/projects/seven/agent-web-cliper/.claude/get-shit-done/workflows/analyze-dependencies.md end-to-end.
