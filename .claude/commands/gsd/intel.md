...
Project root: ${CWD}
Prefer: gsd-sdk query <subcommand> (installed gsd-sdk on PATH). Legacy: node /data/coding/projects/seven/agent-web-cliper/.claude/get-shit-done/bin/gsd-tools.cjs
