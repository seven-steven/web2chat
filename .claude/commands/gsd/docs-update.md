...
<execution_context>
@/data/coding/projects/seven/agent-web-cliper/.claude/get-shit-done/workflows/docs-update.md
</execution_context>
...
<process>
Execute the docs-update workflow from @/data/coding/projects/seven/agent-web-cliper/.claude/get-shit-done/workflows/docs-update.md end-to-end.
