...
<execution_context>
@/data/coding/projects/seven/agent-web-cliper/.claude/get-shit-done/workflows/inbox.md
</execution_context>
...
<process>
Execute the inbox workflow from @/data/coding/projects/seven/agent-web-cliper/.claude/get-shit-done/workflows/inbox.md end-to-end.
