...
<execution_context>
@/data/coding/projects/seven/agent-web-cliper/.claude/get-shit-done/workflows/spec-phase.md
@/data/coding/projects/seven/agent-web-cliper/.claude/get-shit-done/templates/spec.md
</execution_context>
...
<process>
Execute the spec-phase workflow from @/data/coding/projects/seven/agent-web-cliper/.claude/get-shit-done/workflows/spec-phase.md end-to-end.
