...
**Wave 1**
- [ ] 01-1-scaffold-PLAN.md — WXT 脚手架 + manifest + 工程基础设施（CI / Husky / verify-manifest，FND-01 / FND-05）

**Wave 2** *(blocked on Wave 1 completion)*
- [ ] 01-2-storage-i18n-PLAN.md — 存储 schema + 迁移框架 + i18n facade（en + zh_CN，FND-04 / FND-06 / STG-01 / STG-02）

**Wave 3** *(blocked on Wave 2 completion)*
- [ ] 01-3-messaging-sw-PLAN.md — 类型化消息协议 + Service Worker 顶层 listener（FND-02 / FND-03）

**Wave 4** *(blocked on Wave 3 completion)*
- [ ] 01-4-popup-e2e-PLAN.md — Popup（Preact + Tailwind v4）+ Playwright e2e + 端到端验证（FND-01 / FND-06）
