...
- [x] **Phase 5: Discord 适配器** ✓ Executed (2026-05-05) - 4/4 plans, 190 单元测试 + 5 E2E specs (pending human verification) — 兼容 Slate/Lexical 的粘贴注入、SPA 路由处理、ToS 感知的限流器
...
| 5. Discord 适配器      | 4/4            | Complete    | 2026-05-05 |
