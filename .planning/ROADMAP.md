...
**Wave 1** *(并行)*
- [ ] 04-01-PLAN.md — Foundation: ErrorCode 扩展 + dom-injector helper + grantedOrigins storage repo + adapter registry entry + i18n keys + 单元测试 (ADO-03, ADO-06, ADO-07)
- [ ] 04-02-PLAN.md — OpenClaw adapter content script: match/compose/send/canDispatch + 单元测试 (ADO-01, ADO-02, ADO-04)

**Wave 2** *(blocked on Wave 1 completion)*
- [ ] 04-03-PLAN.md — Integration: dispatch-pipeline permission guard + SendForm permission request + ErrorBanner extension + GrantedOriginsSection (ADO-06, ADO-07)

**Wave 3** *(blocked on Wave 2 completion)*
- [ ] 04-04-PLAN.md — E2E: Playwright specs (happy path + offline + permission) + OpenClaw stub fixture (ADO-05)
...
| 4. OpenClaw 适配器     | 0/4            | Not started | -         |
