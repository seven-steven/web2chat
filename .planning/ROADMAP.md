...
- [x] **Phase 5: Discord 适配器** ✓ Executed (2026-05-05) - 6/6 plans (5 original + 1 gap closure), 193 单元测试 + 5 E2E specs (pending human verification) — 兼容 Slate/Lexical 的粘贴注入（MAIN world bridge）、SPA 路由处理、ToS 感知的限流器
...
- [ ] 05-06-PLAN.md — Fix editor clear after send (Escape after Enter) + increase ADAPTER_RESPONSE_TIMEOUT_MS 10s→20s (ADD-03, ADD-04)
