...
- [x] **Phase 5: Discord 适配器** ✓ Executed (2026-05-05) - 5/5 plans, 193 单元测试 + 5 E2E specs (pending human verification) — 兼容 Slate/Lexical 的粘贴注入（MAIN world bridge）、SPA 路由处理、ToS 感知的限流器
...
| 5. Discord 适配器      | 5/5            | Complete    | 2026-05-05 |
